...
async function main() {
  ...
  while (monster.hp > 0 && player.hp > 0) {
    ...
    if (action.choice === "Attack") {
      ...
      console.log(
        chalk.bold.yellow(
          `You strike the ${monster.name} for ${playerDamage} damage.`
        )
      );
      console.log(
        chalk.bold.red(`You receive ${monsterDamage} in retaliation!`)
      );
      ...
      console.log(
        chalk.bold.green(`You drink a health potion and heal for ${heal} HP.`)
      );
      console.log(
        chalk.bold.red(`You receive ${monsterDamage} in retaliation!`)
      );
